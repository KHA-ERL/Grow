                ...
                <div class="flex md:w-1/8 px-3 justify-center py-10 items-center bg-white">
                    <form action="" method="post" class="bg-white flex flex-col w-11/12">
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="text" placeholder="Email" name="mail" id="mail" class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                        ...
                        <label class="inline-flex flex-col py-2">
                            <input type="text" placeholder="Email Password" name="mailp" id="mailp" class="block justify-center items-center text-base px-4 font-medium border border-gray-600 h-12 shadow-sm focus:outline-none text-gray-600 focus:border-green-800"/>
                            <!--<p class="mt-2 invisible peer-invalid:visible text-pink-600 text-sm">
                                Please provide a valid email address.
                            </p>-->
                        </label>
